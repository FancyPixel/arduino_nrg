...
#define CCDEF_MDMCFG4_4800    0xE7   // Speed 4800 bps + banda RX ~67.7 kHz (era 0xC7 = ~102 kHz, valore del 38400). CANDIDATO narrow-band, da misurare.
...
#define CCDEF_DEVIATN_4800   0x15   // Deviazione ~5.2 kHz per 4800 (indice mod ~2). CANDIDATO narrow-band, da misurare.
